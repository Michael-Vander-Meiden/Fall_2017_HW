...
EVAL_FUNS = {
    ...
    'square':   np.square,
    'mul':      # TODO (reuse previous assignment)
    'relu':     # TODO (reuse previous assignment)
    'softMax':  # TODO (reuse previous assignment)
    'crossEnt': # TODO (reuse previous assignment)
    'mean':     # TODO (reuse previous assignment)
    'tanh':     # TODO
    'sigmoid':  # TODO
    'hadamard': # TODO (Hadamard product means element-wise product)
    }
...
BP_FUNS = {
    ...
    'mul':              # TODO (reuse previous assignment)
    'relu':             # TODO (reuse previous assignment)
    'crossEnt-softMax': # TODO (reuse previous assignment)
    'mean':             # TODO (reuse previous assignment)
    'tanh':             # TODO
    'sigmoid':          # TODO
    'hadamard':         # TODO (Hadamard product means element-wise product)
